...
class fmcSearch_v1 extends fmcWidget {
  ...
  function jelly($args, $settings, $type) {
    ...
    if ($submit_button_shine == 'gradient' && !$is_rgba) {
      ...
      $submit_button_css .= "background: -moz-linear-gradient(to top, {$lighter} 0%, {$submit_button_background} 44%, {$darker} 100%) !important;";
      ...
      $submit_button_css .= "background: -webkit-linear-gradient(to top, {$lighter} 0%,{$submit_button_background} 44%,{$darker} 100%) !important;";
      $submit_button_css .= "background: -o-linear-gradient(to top, {$lighter} 0%,{$submit_button_background} 44%,{$darker} 100%) !important;";
      $submit_button_css .= "background: -ms-linear-gradient(to top, {$lighter} 0%,{$submit_button_background} 44%,{$darker} 100%) !important;";
      $submit_button_css .= "background: linear-gradient(to top, {$lighter} 0%,{$submit_button_background} 44%,{$darker} 100%) !important;";
      ...
      $submit_button_css .= "background: -moz-linear-gradient(to top, {$light} 0%, {$lighter} 50%, {$dark} 51%, {$darker} 100%) !important;";
      ...
      $submit_button_css .= "background: -webkit-linear-gradient(to top, {$light} 0%,{$lighter} 50%,{$dark} 51%,{$darker} 100%) !important;";
      $submit_button_css .= "background: -o-linear-gradient(to top, {$light} 0%,{$lighter} 50%,{$dark} 51%,{$darker} 100%) !important;";
      $submit_button_css .= "background: -ms-linear-gradient(to top, {$light} 0%,{$lighter} 50%,{$dark} 51%,{$darker} 100%) !important;";
      $submit_button_css .= "background: linear-gradient(to top, {$light} 0%,{$lighter} 50%,{$dark} 51%,{$darker} 100%) !important;";
    }
