...
1. Add graphs to your market analyses using the market stats widget.
2. Our IDX Search Widget - Width, Color and Font Options Available
3. Our IDX Slideshow Widget - Rotate Listings From Saved Searches and more! 
4. Add widgets to pages or posts using the Gutenberg Block Editor (also compatible with Classic, Elementor and WPBakery)
...
Please call FBS Broker Agent Services at 866-320-9977 or <a href="https://fbsproducts.com/form/wordpress-plugin-secret-key-request" target="_blank">Send us a message here</a> to purchase a key to activate your plugin.



== Resources ==

###<a href="https://fbsproducts.com/form/wordpress-plugin-secret-key-request" target="_blank">Get a Key & Secret</a>###
...
= 3.15.1 =
Efficiency Update
* Removed bulky cbox elements in modal windows
* Resolved Listing Detail Fields Not Printing For Some Property Types

= 3.15 =
New Feature
* NEW! Version 2 Market Statistics Widget Styles


= 3.14.30 =
New Feature
* Added Listings Per Page Setting to Listing Summary Widget
...
= 3.14.28 =
Efficiency Update
* Resolved Phone Number Field Requirement in Contact Agent Form
* Security Improvements

= 3.14.27 =
* More Security Improvements For Plugin Settings Pages
...
* Refactored PHP for Listing No Longer Available Page
* Improved Security for Plugin Key

= 3.14.24 =
Efficiency Update
* Fixed Log-In Widget Caching Issue
...
* Resolved Meta Description Not Printing on Listing Detail Pages

= 3.14.21 =
Efficiency Update
* PHP Warnings and Deprecation Notifications Resolved
* Updated Block Categories for Gutenberg editor
* Listing Not Available page set to noindex and nofollow
* Subdivision is now a sticky value in the IDX Search widget
* Listing Agent IDX Display Requirement Resolved For V2 Listing Template
* Updated Plugin Pages To Use WP get_post Method

= 3.14.20 =
Efficiency Update
* Added AutoHeight to V2 Listing Detail Page Images
* Removed deprecated browser preload from V1 Listing Template
* PHP Warnings Resolved For Search Result Pages

= 3.14.19 = 
Efficiency Update
* More Information Expands By Default in V2 Listing Detail Pages
* Improved Default Log-In Widget Styling
* Primary Color Applies To Log-In and Contact Me Widget Buttons

= 3.14.18 = 
Efficiency Update
* Added UserAgent and IP To API headers
* Set StandardStatus as fallback to MLSStatus API Field

= 3.14.16 = 
Efficiency Update
* Updated Plugin Screenshots
* Updated "Get Your Key" URL
* Updated Version 1 Listing Template List/Sold Price Field 

= 3.14.15 =
Efficiency Update
* Repush of Version 3.14.14

= 3.14.14 =
Efficiency Update
* Fixed Listing Summary Data Share Images

= 3.14.13 =
Efficiency Update
* Fixed Slidshow Widget Sorting Error
* Fixed Slideshow Widget Listing Address Display
* Turned Off Autofill With Plugin Key Fields
* List/Sold Price Display
